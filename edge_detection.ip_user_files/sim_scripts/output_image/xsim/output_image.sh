...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot output_image xil_defaultlib.output_image -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim output_image -key {Behavioral:sim_1:Functional:output_image} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb output_image.wdb xsim.dir)
