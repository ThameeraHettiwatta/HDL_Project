...
HD_PWD='D:/thameera/ACA Folder/sem8/hdl/project/HDL_Project/edge_detection.runs/output_image_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log output_image.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source output_image.tcl
